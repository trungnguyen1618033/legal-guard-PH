...
def test_memory_eval_lexical_perfect():
    ...
    assert r["org_isolation"] and r["noise_rejection"] and r["supersede_ok"] and r["consolidation_ok"]  # cô lập + nhiễu + bi-temporal + consolidation
...
def test_memory_eval_semantic_perfect(tmp_path):
    ...
    assert r["org_isolation"] and r["noise_rejection"] and r["supersede_ok"] and r["consolidation_ok"]  # + supersede + consolidation
