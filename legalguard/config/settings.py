...
class Settings(BaseSettings):
    ...
    agentic_memory: bool = True         # BỘ NHỚ AGENT theo đối tác (anchor CockroachDB): ghi tình tiết khi record_outcome (async, ngoài hot-path) + recall inject vào đàm phán. BẬT MẶC ĐỊNH (đã wire+gate accuracy 53/54=98% no-regress) — tính năng đinh của bản CRDB. Tắt: AGENTIC_MEMORY=0
