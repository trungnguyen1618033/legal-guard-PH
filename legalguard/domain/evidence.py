"""Use-case evidence doanh thu (cho XPRIZE).

Tính tổng doanh thu + breakdown theo tháng 5–8/2026, tách riêng related-party,
đếm khách thật — đúng những gì giám khảo XPRIZE yêu cầu nộp.
"""
...
# Cửa sổ doanh thu hợp lệ của XPRIZE.
XPRIZE_MONTHS = ("2026-05", "2026-06", "2026-07", "2026-08")
...
class EvidenceService:
    ...
    def summary(self) -> dict:
        ...
        by_month = {m: 0.0 for m in XPRIZE_MONTHS}
        for e in organic:
            month = e.date[:7]
